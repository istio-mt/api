...
func (Tracing_OpenCensusAgent_TraceContext) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5efecd978cf3d28d, []int{0, 5, 0}
}
...
type Tracing_Skywalking_ struct {
	Skywalking *Tracing_Skywalking `protobuf:"bytes,10,opt,name=skywalking,proto3,oneof"`
}
...
func (*Tracing_Skywalking_) isTracing_Tracer()      {}
...
func (m *Tracing) GetSkywalking() *Tracing_Skywalking {
	if x, ok := m.GetTracer().(*Tracing_Skywalking_); ok {
		return x.Skywalking
	}
	return nil
}
...
type Tracing_Skywalking struct {
	// Address of the Skywalking oap service (e.g. _skywalking-oap:11800_).
	Address              string   `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *Tracing_Skywalking) Reset()         { *m = Tracing_Skywalking{} }
func (m *Tracing_Skywalking) String() string { return proto.CompactTextString(m) }
func (*Tracing_Skywalking) ProtoMessage()    {}
func (*Tracing_Skywalking) Descriptor() ([]byte, []int) {
	return fileDescriptor_5efecd978cf3d28d, []int{0, 1}
}
func (m *Tracing_Skywalking) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Tracing_Skywalking) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Tracing_Skywalking.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Tracing_Skywalking) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Tracing_Skywalking.Merge(m, src)
}
func (m *Tracing_Skywalking) XXX_Size() int {
	return m.Size()
}
func (m *Tracing_Skywalking) XXX_DiscardUnknown() {
	xxx_messageInfo_Tracing_Skywalking.DiscardUnknown(m)
}

var xxx_messageInfo_Tracing_Skywalking proto.InternalMessageInfo

func (m *Tracing_Skywalking) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*Tracing_Skywalking)(nil), "istio.mesh.v1alpha1.Tracing.Skywalking")
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
...
func (m *Tracing_Skywalking_) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *Tracing_Skywalking_) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Skywalking != nil {
		{
...
func (m *Tracing_Skywalking) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Tracing_Skywalking) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Tracing_Skywalking) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Tracing_Skywalking_) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Tracing_Skywalking) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Tracing) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			v := &Tracing_Skywalking{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Tracer = &Tracing_Skywalking_{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProxy(dAtA[iNdEx:])
...
func (m *Tracing_Skywalking) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Skywalking: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Skywalking: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
